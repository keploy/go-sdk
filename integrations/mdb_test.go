...
func TestMDB(t *testing.T){
	...
	collection := NewMongoDB(client.Database("test").Collection("client"))
	

	//test for findOne method
	fmt.Printf("FindOne.Decode : \n")
			...
			ctx: context.WithValue(context.TODO(), keploy.KCTX, &keploy.Context{
				...
				Deps:   []keploy.Dependency{
							keploy.Dependency{
								...
								Data: [][]byte{
									[]byte{47, 255, 133, 3, 1, 1, 7, 84, 114, 97, 105, 110, 101, 114, 1, 255, 134, 0, 1, 3, 1, 4, 78, 97, 109, 101, 1, 12, 0, 1, 3, 65, 103, 101, 1, 4, 0, 1, 4, 67, 105, 116, 121, 1, 12, 0, 0, 0, 23, 255, 134, 1, 3, 65, 115, 104, 1, 20, 1, 11, 80, 97, 108, 108, 101, 116, 32, 84, 111, 119, 110, 0},
									[]byte{10, 255, 129, 5, 1, 2, 255, 132, 0, 0, 0, 5, 255, 130, 0, 1, 1},
								},
							},
						},
			}),
			...
			ctx: context.WithValue(context.TODO(), keploy.KCTX, &keploy.Context{
				...
				Deps:   []keploy.Dependency{
							keploy.Dependency{
								...
								Data: [][]byte{
									[]byte{47, 255, 133, 3, 1, 1, 7, 84, 114, 97, 105, 110, 101, 114, 1, 255, 134, 0, 1, 3, 1, 4, 78, 97, 109, 101, 1, 12, 0, 1, 3, 65, 103, 101, 1, 4, 0, 1, 4, 67, 105, 116, 121, 1, 12, 0, 0, 0, 3, 255, 134, 0},
									[]byte{10, 255, 129, 5, 1, 2, 255, 132, 0, 0, 0, 34, 255, 130, 0, 30, 1, 109, 111, 110, 103, 111, 58, 32, 110, 111, 32, 100, 111, 99, 117, 109, 101, 110, 116, 115, 32, 105, 110, 32, 114, 101, 115, 117, 108, 116},
								},
							},
						},
			}),
