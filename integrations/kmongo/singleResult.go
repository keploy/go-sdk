...
//  - In "record" mode, stores the encoded output(generated by mocked methods of mongo.SingleResult) into keploy's Context Deps array.
...
// Err mocks mongo's SingleResult Err() which will called in "record" or "off" mode as stated above in SingleResult.
//
...
// Decode mocks mongo's SingleResult.Decode which will called in "record" or "off" mode as stated above in SingleResult.
//
